...
# ones.
extensions = [
    'sphinx.ext.napoleon',  # Sphinx library for parsing Google-formatted docstrings
    'sphinx.ext.autodoc',  # Core Sphinx library for auto html doc generation from docstrings
    'sphinx.ext.autosummary',  # Create neat summary tables for modules/classes/methods etc
    'sphinx.ext.intersphinx',  # Link to other project's documentation (see mapping below)
    # 'sphinx.ext.viewcode',  # Add a link to the Python source code for classes, functions etc.
    'sphinx.ext.linkcode',  # Add external link to the Python source code for classes, functions etc.
...
intersphinx_mapping = {
    ...
    'videolib': ('http://videolib.readthedocs.io/en/latest', None)
}
...
def linkcode_resolve(domain, info):
    ...
    filename = f'https://github.com/abhinaukumar/qualitylib/blob/main/{filename}.py'
    return filename
